...
class Restaurant {
    ...
    var address by Delegates.notNull<Address>()
        private set
    var rating: Int = com.example.lokma.constant.Rating.NORMAL   // as default
        private set
    var menu: Menu? = null
        private set
    ...
    fun rating(rating: Int): Rating {
        return when (rating) {
            com.example.lokma.constant.Rating.VERY_GOOD -> Rating(
                R.drawable.ic_rating_amazing,
                "Amazing"
            )

            com.example.lokma.constant.Rating.GOOD -> Rating(
                R.drawable.ic_rating_very_good,
                "Very good"
            )

            com.example.lokma.constant.Rating.NORMAL -> Rating(
    ...
    class Rating(val image: Int, val title: String)
